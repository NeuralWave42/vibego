...
export default function MysticalTripOracle() {
  ...
  useEffect(() => {
    ...
    if (ambientAudio && typeof window !== "undefined") {
      // Placeholder for ambient audio initialization
    }
  }, [ambientAudio])

  const handleOracleComplete = async (profile: any) => {
    setSoulProfile(profile);
    // Store the results in Firebase
    await updateProfile({ soulProfile: profile });
  ...
  // If the user has already completed the oracle, take them to the next step
  useEffect(() => {
    if (userProfile?.soulProfile) {
      setSoulProfile(userProfile.soulProfile);
      setCurrentRealm("journey");
    }
  }, [userProfile]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 animate-pulse">
            <Stars className="h-6 w-6 text-amber-300 opacity-70" />
          </div>
          <div className="absolute top-40 right-20 animate-bounce">
            <Moon className="h-8 w-8 text-blue-300 opacity-60" />
          </div>
          <div className="absolute bottom-32 left-1/4 animate-pulse">
            <Sun className="h-5 w-5 text-orange-300 opacity-50" />
          </div>
            ...
            <CardContent className="p-12 text-center">
              ...
              <div className="mb-12">
                <div className="flex items-center justify-center gap-3 mb-6">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 h-12 w-12 text-amber-400 animate-ping opacity-30">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 h-12 w-12 text-rose-400 animate-ping opacity-30">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-12">
                <div className="group cursor-pointer">
                  <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  ...
                  <p className="text-slate-300 text-sm">
                    Unveil your travel essence through mystical personality revelation
                  </p>
                </div>

                <div className="group cursor-pointer">
                  <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-blue-500 to-teal-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <div className="group cursor-pointer">
                  <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
              ...
              <div className="mb-12 p-6 bg-gradient-to-r from-purple-900/40 to-pink-900/40 rounded-2xl border border-purple-400/20 backdrop-blur-sm">
                <p className="text-xl italic text-purple-100 mb-2">
                  "The journey of a thousand miles begins with a single step into the unknown depths of your soul."
                </p>
              ...
              <div className="mb-8">
                <Button
                  ...
                  className="border-purple-300/50 text-purple-200 hover:bg-purple-800/20 bg-white/5"
                >
              ...
              <div className="space-y-4">
                <Button
                  onClick={() => setCurrentRealm("oracle")}
                  size="lg"
                  className="bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 hover:from-purple-700 hover:via-pink-700 hover:to-orange-600 text-white px-12 py-4 text-xl font-semibold rounded-full shadow-2xl hover:shadow-purple-500/25 transition-all duration-500 transform hover:scale-105"
                >
